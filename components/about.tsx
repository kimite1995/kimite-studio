        ...
        <div className="grid md:grid-cols-12 gap-x-12 gap-y-12 items-start">
          ...
          <div className="md:col-span-5">
            <div className="sticky top-24">
              ...
              <h2 className="text-6xl font-semibold tracking-[-1px] leading-[1.1] mb-8">
                {site.about.title}
              </h2>
          ...
          <div className="md:col-span-7 space-y-8 text-lg leading-relaxed text-[#C4C4C8]">
            <p className="whitespace-pre-line">{site.about.intro}</p>
            <p className="text-[#E8D5A3] font-medium tracking-[-0.2px] whitespace-pre-line">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 pt-8 border-t border-[#222228]">
              {site.about.stats.map((stat, idx) => (
                <div key={idx}>
                  <div className="text-4xl font-semibold tracking-tighter tabular-nums text-white">
